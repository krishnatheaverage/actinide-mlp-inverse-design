...
% Journal of Chemical Information and Modeling style (achemso). Built with tectonic.
...
% ---- result macros: auto-generated from results/*.json by fill_macros.py ----
...
number in this manuscript from committed JSON outputs. Archival deposition under a
persistent DOI (Zenodo) accompanies publication. No proprietary data or codes are
used; every number is reproducible on a single laptop.
