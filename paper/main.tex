...
Zenodo under the concept DOI 10.5281/zenodo.20764583, which always resolves to the
latest release (individual releases carry their own version DOIs beneath it). No
proprietary data or codes are used; every number is reproducible on a single laptop.
